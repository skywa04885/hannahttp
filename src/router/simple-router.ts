...
import { HTTPRouter } from "./base";

export type HTTPSimpleRouterCallback = (
  match: HTTPPathMatch,
  request: HTTPRequest,
...
export type HTTPSimpleRouterHandler = HTTPSimpleRouterCallback | HTTPSimpleRouter;
...
export class HTTPSimpleRouter extends HTTPRouter {
  ...
  public *callbacks(
    ...
    path: string
  ): Generator<[HTTPPathMatch, HTTPSimpleRouterCallback]> {
